        ...
        <div className={` ${className}`}>
            <div className="relative">
                ...
                >
                    ...
                    <div className={`hidden group-focus:block group-active:block group-hover:block absolute right-0 top-12 rounded-md w-56 ring ${config.secondary}`}>
                        ...
                        <ul>
                            ...
                            <li>
                                <a className={`${"block cursor-pointer text-left px-4 py-2 w-full hover:bg-slate-500/50 active::bg-slate-500/50 focus::bg-slate-500/50"}`} onClick={() => setTheme('tokyo-night-dark')}>
                                    Tokyo Night Dark
                                </a>
                            </li>
                        </ul>
