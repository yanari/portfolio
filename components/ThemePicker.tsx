    ...
    return (
        <div className={`group ${className}`}>
            <button
                ...
                aria-haspopup="menu"
                aria-expanded
                className={`cursor-pointer focus:outline-none rounded-md p-2 ring ${config.secondary} hover:bg-slate-800`}
            >
            ...
            <div className={`group-focus:block group-active:block group-hover:block hidden absolute right-0 top-12 rounded-md w-56 ring ${config.secondary}`}>
